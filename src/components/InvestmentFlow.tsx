              ...
              <form onSubmit={signUpForm.handleSubmit(onSignUpSubmit)} className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Enter your full name" {...field} className="bg-dark-highlight border-electric/30 text-black" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Enter your email" {...field} className="bg-dark-highlight border-electric/30 text-black" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Enter your phone number" {...field} className="bg-dark-highlight border-electric/30 text-black" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <div className="space-y-2">
                  ...
                  <InputOTP maxLength={6} value={otp} onChange={setOtp}>
                    <InputOTPGroup>
                      <InputOTPSlot index={0} className="bg-white text-black" />
                      <InputOTPSlot index={1} className="bg-white text-black" />
                      <InputOTPSlot index={2} className="bg-white text-black" />
                      <InputOTPSlot index={3} className="bg-white text-black" />
                      <InputOTPSlot index={4} className="bg-white text-black" />
                      <InputOTPSlot index={5} className="bg-white text-black" />
                    </InputOTPGroup>
                  </InputOTP>
                </div>
                <Button type="submit" className="w-full bg-[#4CAF50] hover:bg-[#45a049] text-white font-bold">
                  Proceed
                </Button>
              </form>
            </Form>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Enter your legal full name" {...field} className="bg-dark-highlight border-electric/30 text-black" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="date" {...field} className="bg-dark-highlight border-electric/30 text-black" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Enter your residential address" {...field} className="bg-dark-highlight border-electric/30 text-black" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
      ...
      case "wallet":
        return (
          <div className="mt-4 space-y-4">
            ...
            <Button onClick={handleNextStep} className="w-full bg-[#4CAF50] hover:bg-[#45a049] text-white font-bold">
              Skip for Now
            </Button>
          </div>
        );
                ...
                {!useCrypto ? (
                  <div className="space-y-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Enter amount" {...field} className="bg-dark-highlight border-electric/30 text-black" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <div className="space-y-2">
                      ...
                      <Input placeholder="Card Number" className="bg-dark-highlight border-electric/30 text-black" />
                      <div className="grid grid-cols-2 gap-2">
                        <Input placeholder="MM/YY" className="bg-dark-highlight border-electric/30 text-black" />
                        <Input placeholder="CVC" className="bg-dark-highlight border-electric/30 text-black" />
                      </div>
                    </div>
                  </div>
                ) : (
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="pl-4">
            {timelineSteps.map((step, index) => (
              <div key={index} className="timeline-step relative mb-10 last:mb-0">
                ...
                <div 
                  className="timeline-content group cursor-pointer hover:bg-dark-highlight/20 p-3 rounded-lg transition-all"
          ...
          <div className="mt-8 flex justify-center">
            <Button 
              onClick={startInvestmentFlow}
              className="bg-[#4CAF50] hover:bg-[#45a049] text-white font-bold px-8 py-3 rounded-lg text-lg"
            >
              Start Investment Process
            </Button>
          </div>
          
          {/* Sequential Investment Process Modal */}
            ...
            <DialogContent className="bg-dark border border-electric/30 text-white w-full max-w-md sm:max-w-lg md:max-w-xl">
              <DialogHeader>
                <DialogTitle className="text-2xl flex items-center gap-2 text-electric">
                  ...
                  <span>{timelineSteps[currentStep].title}</span>
                </DialogTitle>
                <DialogDescription className="text-gray-300 text-base">
                  {timelineSteps[currentStep].details}
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="mt-6 flex items-center justify-center">
                {timelineSteps.map((_, index) => (
                  <div 
                    key={index}
                    className={`w-2 h-2 mx-1 rounded-full ${index === currentStep ? 'bg-electric' : 'bg-gray-600'}`}
                  />
                ))}
              </div>
            </DialogContent>
